...
The system SHALL support using the Middle Mouse Button as the B key in HYN mode and Navigation mode, enabled by default, and support Space + Middle Click for simple middle click.
...
- **THEN** the system sends a simple standard middle mouse click.
