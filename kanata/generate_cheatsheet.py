...
def main():
    ...
    mouse_items = [
        ...
        ("Ctrl + B", "Switch Mid-Click: Double vs Single NVDA Mode"),
        ("Mode 1 (Double)", "Normal Middle Click  |  Double-Click = NVDA"),
        ("Mode 2 (Single)", "Middle Click = NVDA  |  Space+Click = Normal"),
